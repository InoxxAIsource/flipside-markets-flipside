// Simple deployment script for AMM contracts
...
async function main() {
  ...
  console.log("2. Update .env with: AMM_POOL_FACTORY_ADDRESS=${ammPoolFactoryAddress}");
  console.log("3. Test pool creation via factory.createPool()");
}
